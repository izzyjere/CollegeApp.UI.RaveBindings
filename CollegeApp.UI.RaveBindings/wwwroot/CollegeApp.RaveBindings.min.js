...
function makePayment(publicKey,paymentOptions,currency, amount, tranRef,customer, customerId, customerMac, phone, email, title,description, logo = "",oncomplete,onfail, dotnetHelper) {
    const modal = FlutterwaveCheckout({
        ...
        callback: function (payment) {
            ...
            dotnetHelper.invokeMethodAsync(oncomplete, json);
            modal.close();
        },
        onclose: function (incomplete) {
            if (incomplete === true) {
                dotnetHelper.invokeMethodAsync(onfail, json); 
            }
        }
    });
}