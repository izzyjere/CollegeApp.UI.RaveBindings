...
function makePayment(publicKey,paymentOptions,currency, amount, tranRef,customer, customerId, customerMac, phone, email, title,description, logo = "", dotnetHelper) {
    const modal = FlutterwaveCheckout({
        ...
        callback: function (payment) {
            ...
            dotnetHelper.invokeMethodAsync("OnPaymentComplete", json);
            modal.close();
        },
        onclose: function (incomplete) {
            if (incomplete === true) {
                dotnetHelper.invokeMethodAsync("OnPaymentFailed", json); 
            }
        }
    });
}